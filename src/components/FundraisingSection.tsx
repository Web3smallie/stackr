            ...
            <div className="grid grid-cols-4 gap-2 mb-4">
              {allTokens.map((token) => (
                <button
                  key={token}
                  type="button"
                  onClick={() => setContributionToken(token)}
                  className={`rounded-lg px-2 py-2 text-xs font-semibold border transition-all ${
                    contributionToken === token ? "border-primary/60 bg-primary text-primary-foreground" : "border-border bg-secondary text-muted-foreground"
                  }`}
                >
                  {token}
                </button>
            ...
            <div className="grid grid-cols-4 gap-2 mb-5">
              {allTokens.map((token) => (
                <button
                  ...
                  className={`rounded-lg px-2 py-2 text-xs font-semibold border transition-all ${form.token === token ? "border-primary/60 bg-primary text-primary-foreground" : "border-border bg-secondary text-muted-foreground"}`}
                >
                  {token}
                </button>
              ))}
